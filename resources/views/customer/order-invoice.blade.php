...
<!-- Mirrored from angfuzsoft.com/html/invce/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Feb 2023 07:24:53 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/invoice-assets/css/app.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/invoice-assets/css/style.css') }}">
</head>
...
<body>
        ...
        <div class="invoice-container">
            <main>
                <div class="as-invoice invoice_style1">
                    <div class="download-inner" id="download_section">
                        <header class="as-header header-layout1">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto">
                                    {{-- <div class="header-logo"><a href="index.html"><img src="{{ asset('assets/invoice-assets/img/logo.svg') }}" alt="Invce"></a></div> --}}
                                    <div class="header-logo"><a href="index.html"><img src="{{ asset(config('setting_data.HEADER_LOGO')) }}" style="width: 200px" alt="Invce"></a></div>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="header-bottom">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <div class="border-line"><img src="{{ asset('assets/invoice-assets/img/bg/line_pattern.svg') }}" alt="line"></div>
                                    </div>
                                    <div class="col-auto">
                                        <p class="invoice-number me-4"><b>Order No: </b>{{ $orderDetail->order_no }}</p>
                                    </div>
                                    <div class="col-auto">
                                        <p class="invoice-date"><b>Date: </b> {{ $orderDetail->created_at->format('Y-m-d') }} </p>
                                    </div>
                                </div>
                            </div>
                        </header>
                        <div class="row justify-content-between mb-4">
                            <div class="col-auto">
                                <div class="invoice-left"><b>Invoiced To:</b>
                                    <address>{{ $orderDetail->user->userAddress->first()->full_address }}<br>{{ $orderDetail->user->userAddress->first()->city }},<br>{{ $orderDetail->user->userAddress->first()->pincode }}.</address>
                                </div>
                            </div>
                            @php
                                $footerAddress = config('setting_data.FOOTER_ADDRESS');
                                $addressParts = explode(',', $footerAddress); // Explode by comma
                            @endphp
                            <div class="col-auto">
                                <div class="invoice-right"><b>Pay To:</b>
                                    ...
                                    {{-- <address>{{ config('setting_data.FOOTER_ADDRESS') }} </address> --}}
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody>
                                @foreach ($orderDetail->orderItems as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <span>₹{{ $orderDetail->gst_charge }}</span>
                                        </td>
                                        <td>
                                            <span>₹{{ $orderDetail->charges }}</span>
                                        </td>
                                        <td>
                                            <span>₹{{ $orderDetail->service_charge }}</span>
                                        </td>
                                        <td>
                                            <span>₹{{ $item->amount }}</span>
                                        </td>
                                        <td>
                                            <span>₹{{ $subTotal = $orderDetail->gst_charge + $orderDetail->charge + $orderDetail->service_charge + $item->amount }}</span>
                                        </td>
                                    </tr>
                                @endforeach
                        ...
                        <div class="row justify-content-between">
                            ...
                            <div class="col-auto">
                                <div class="invoice-left">
                                    <p><strong>Customer Name: </strong> <span>{{$orderDetail->user->name}}</span></p>
                                    <p><strong>Mobile No.:</strong> <span>+91{{$orderDetail->user->mobile}}</span></p>
                                </div>
                            </div>
                            <div class="col-auto">
                                <table class="total-table">
                                    {{-- <tr>
                                        <th>Tax:</th>
                                        <td>₹{{ $taxAmount = ($orderDetail->total * $orderDetail->gst_charge) / 100 }}</td>
                                    </tr> --}}
                                    @php
                                        $grandTotal = 0;
                                    @endphp
                                    <tr>
                                        ...
                                        <td> <span>{{ $grandTotal = +$orderDetail->total }}</span> </td>
                                        {{-- @endforeach --}}
                                    </tr>
                                    {{-- <tr>
                                        <th>Grand Total:</th>
                        ...
                        <p class="invoice-note mt-3"><svg width="13" height="16" viewBox="0 0 13 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="invoice-buttons"><button class="print_btn"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        {{-- <button id="download_btn" class="download_btn"><svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
    ...
    <script src="{{ asset('assets/invoice-assets/js/vendor/jquery-3.6.0.min.js') }}"></script>
    <script src="{{ asset('assets/invoice-assets/js/app.min.js') }}"></script>
    <script src="{{ asset('assets/invoice-assets/js/main.js') }}"></script>
</body>
<!-- Mirrored from angfuzsoft.com/html/invce/demo/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 22 Feb 2023 07:25:02 GMT -->
