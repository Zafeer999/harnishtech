            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mb-sm-15">
                        @guest
                            <div class="toggle_info py-4">
                                <span class="d-block my-1"><i class="fi-rs-user mr-10"></i><span class="text-muted">Already have an account?</span> <a href="{{ route('customer.login') }}" data-bs-toggle="collapse" class="collapsed" aria-expanded="false">Click here to login</a></span>
                            </div>
                        @endguest
                    </div>
                    <div class="col-lg-6">
                        <div class="toggle_info py-3">
                            <form method="post" class="apply-coupon input-group">
