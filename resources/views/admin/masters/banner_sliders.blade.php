                                    ...
                                    <tbody>
                                        @foreach ($bannerSliders as $bannerSlider)
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="{{ $bannerSlider->image }}" style="max-width: 100px; max-height: 100px;" alt="bannerslider_img">
                                                </td>
                                                <td>
                                                    <p> {{ $bannerSlider->small_text }} </p>
                                                </td>
                                                <td>
                                                    <p> {{ $bannerSlider->main_black_text }} </p>
                                                </td>
                                                <td>
                                                    <p> {{ $bannerSlider->main_color_text }} </p>
                                                </td>
                                                <td>
                                                    <div style="width: 30px; height: 30px; background-color: {{ $bannerSlider->text_color }}; display: inline-block; border: 1px solid #ccc;"></div>
                                                <td>
                                                    <p> {{ $bannerSlider->offer_text }} </p>
                                                </td>
                                                <td>
                                                    <p> {{ $bannerSlider->button_text }} </p>
                                                </td>
                                                <td>
                                                    <div style="width: 30px; height: 30px; background-color: {{ $bannerSlider->button_color }}; display: inline-block; border: 1px solid #ccc;"></div>
                                                </td>
                                                <td>
                                                    <p> {{ $bannerSlider->button_link ? $bannerSlider->button_link : '-' }} </p>
                                                </td>
                                                <td>
        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (!data.error) {
                    ...
                    $("#editForm [name='bannerslider_id']").val(data.bannerSlider.id);
                    $("#editForm #edit_image_section").html(data.bannerImgHtml);
                    $("#editForm [name='small_text']").val(data.bannerSlider.small_text);
                    $("#editForm [name='main_black_text']").val(data.bannerSlider.main_black_text);
                    $("#editForm [name='main_color_text']").val(data.bannerSlider.main_color_text);
                    $("#editForm [name='text_color']").html(data.textColorHTML);
                    $("#editForm [name='offer_text']").val(data.bannerSlider.offer_text);
                    $("#editForm [name='button_text']").val(data.bannerSlider.button_text);
                    $("#editForm [name='button_color']").val(data.bannerSlider.button_color);
                    $("#editForm [name='button_link']").val(data.bannerSlider.button_link);
                    $("#editForm [name='status']").val(data.bannerSlider.status);
                } else {
                    alert(data.error);
                }
            },
