        ...
        $.ajax({
            ...
            success: function(data, textStatus, jqXHR) {
                ...
                if (!data.error) {
                    ...
                    $("#editForm input[name='timeslot_id']").val(data.city.id);
                    $("#editForm input[name='name']").val(data.city.name);
                    $("#editForm input[name='from_time']").val(data.city.from_time);
                    $("#editForm input[name='to_time']").val(data.city.to_time);
                } else {
                    alert(data.error);
                }
            },
